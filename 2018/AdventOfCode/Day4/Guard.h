...
public:
   ...
   unsigned int max_sleep_minute() const; // Returns the minute of the hour that this guard sleeps the most
   unsigned int max_sleep_count() const; // Returns the number of times this guard sleeps at that minute
