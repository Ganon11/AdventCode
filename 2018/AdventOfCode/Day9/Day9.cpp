...
int main()
{
   ...
   std::wcout << players << L" players; last marble is worth " << max_marbles << L" points: high score is " << winning_score << std::endl;

   MarbleList list2{ players, max_marbles * 100 };
   winning_score = list2.play_game();
   std::wcout << players << L" players; last marble is worth " << max_marbles * 100 << L" points: high score is " << winning_score << std::endl;
