namespace PositionTests
{
   ...
   public class GetPointsInLineTests
   {
      ...
      public void Test_PointsInLineEmptyForInvalidLines()
      {
         ...
         IEnumerable<Position.Position> points = Position.Position.GetPointsInLine(p1, p2);
      ...
      public void Test_PointsInHorizontalLine()
      {
         ...
         List<Position.Position> subpositions = new List<Position.Position>() {
            p1,
            new Position.Position(2, 2, 3),
            new Position.Position(3, 2, 3),
            p2
         };
         List<Position.Position> line = Position.Position.GetPointsInLine(p1, p2).ToList();
      ...
      public void Test_PointsInLine_OrderDoesNotMatter()
      {
         Position.Position p1 = new(1, 2, 3);
         Position.Position p2 = new(1, 2, 6);
         IEnumerable<Position.Position> line1 = Position.Position.GetPointsInLine(p1, p2);
         IEnumerable<Position.Position> line2 = Position.Position.GetPointsInLine(p2, p1);
      ...
      public void Test_PointsInLine_OnePoint()
      {
         ...
         IEnumerable<Position.Position> line = Position.Position.GetPointsInLine(p, p);
